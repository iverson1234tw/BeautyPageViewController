...
- (CGRect)frameForFillerSelectionIndicator {
    ...
    // 這邊改變Box的寬度和高度
    if (_selectionStyle == HMSegmentedControlSelectionStyleBox) {
        
        return CGRectMake(self.segmentWidth * self.selectedSegmentIndex + 15, 10, self.segmentWidth - 30, CGRectGetHeight(self.frame) - 20);
    }
